...
public class Lich {
	...
	System.out.print(Solar2Lunar(23,10,2023));
}
...
public static final double[] SUNLONG_MAJOR = new double[] {
	...
	// chuyển đổi ngày julius / ngày dương lịch theo giò địa phương 
	public static int[] LocalFromJD(double JD) {
		return UniversalFromJD(JD + TimeZone.LONG/24.0);
	}
	
	public static double LocalToJD(int D, int M, int Y) {
		return UniversalToJD(D, M, Y) - TimeZone.LONG/24.0;
	}
	...
	// đổi số ngày dương lịch ra ngày julius
