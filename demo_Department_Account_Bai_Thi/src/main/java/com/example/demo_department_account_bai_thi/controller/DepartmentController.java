...
//        if(account==null){
//            return ResponseEntity.ok("khong tim thay account:"+username);
//        }
    ...
    public  ResponseEntity<?> updateDepart(@RequestBody DepartmentUpdateReq departmentUpdateReq){
        Optional<Department> opDepart= departmentRepo.findById(departmentUpdateReq.getId());
