...
namespace QuanLyPhongTro.Controllers
{
    ...
    public class BookedRoomController : ComponentsController
    {
        ...
        public async Task<IActionResult> TimKiemPhongDaDat(string tinhthanh,int pg = 1)
        {
            Authencation();
            const int pageSize = 3;
            if (pg < 1)
            ...
            var list = model.GetRoomBookedTheoTinhThanh(userID, recSkip, pageSize,tinhthanh);
